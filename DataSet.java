...
public class DataSet {
 ...
 public static double distanceEuclid(DataPoint val1, DataPoint val2){
   ...
   double distance = 0;
    ...
    {
      distanceSquared = distanceSquared + Math.pow((x1[i] - x2[i]),2);
    }
    distance = Math.pow(distanceSquared, 0.5);
